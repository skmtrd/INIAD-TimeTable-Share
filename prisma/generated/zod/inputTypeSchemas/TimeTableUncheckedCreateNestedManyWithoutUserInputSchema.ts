...
export const TimeTableUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.TimeTableUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.TimeTableUncheckedCreateNestedManyWithoutUserInput>;

export default TimeTableUncheckedCreateNestedManyWithoutUserInputSchema;
