...
export const LectureDeleteArgsSchema: z.ZodType<Prisma.LectureDeleteArgs> = z
  .object({
    select: LectureSelectSchema.optional(),
    include: z.lazy(() => LectureIncludeSchema).optional(),
    where: LectureWhereUniqueInputSchema,
  })
  .strict() as z.ZodType<Prisma.LectureDeleteArgs>;

export default LectureDeleteArgsSchema;
