...
export const LectureCreateArgsSchema: z.ZodType<Prisma.LectureCreateArgs> = z
  .object({
  ...
  .strict() as z.ZodType<Prisma.LectureCreateArgs>;

export default LectureCreateArgsSchema;
